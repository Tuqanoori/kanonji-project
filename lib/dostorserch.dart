...
class destorpage extends StatefulWidget {
  const destorpage({Key? key}) : super(key: key);

  @override
  _destorpageState createState() => _destorpageState();
}

class _destorpageState extends State<destorpage> {
          ...
          SizedBox(
            ...
            Container(
              //color: Colors.black45,
                ...
                width:450,
                child: ElevatedButton(
                  child: new Text(' قراءة الدستور بالكامل و البحث عن كلمة فيها', maxLines: 2, overflow: TextOverflow.ellipsis,style:TextStyle(
                    //fontStyle: FontStyle.italic,
                    color: Colors.white,
                    fontWeight: FontWeight.w500,
                    fontSize: 15,
                  ...
                  onPressed: () => {
                    setState(() {
                      ...
                      Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => dostor()));
                    })
                  },
                )
            ),
