...
class wizraa extends StatefulWidget {
  const wizraa({Key? key}) : super(key: key);

  @override
  _wizraaState createState() => _wizraaState();
}

class _wizraaState extends State<wizraa> {
            ...
            Image.asset(
              ...
              //color: Colors.black45,
                ...
                child: ElevatedButton(
                  child: new Text('عرض قرارمجلس الوزراء',style:TextStyle(
                    //fontStyle: FontStyle.italic,
                    color: Colors.white,
                    fontWeight: FontWeight.w500,
                    fontSize: 15,
