...
class althora extends StatefulWidget {
  const althora({Key? key}) : super(key: key);

  @override
  _althoraState createState() => _althoraState();
}

class _althoraState extends State<althora> {
            ...
            Image.asset(
              ...
              //color: Colors.black45,
                ...
                child: ElevatedButton(
                  child: new Text('عرض قرارات مجلس قيادة الثورةالمنحل',style:TextStyle(
                    //fontStyle: FontStyle.italic,
                    color: Colors.white,
                    fontWeight: FontWeight.w500,
                    fontSize: 15,
